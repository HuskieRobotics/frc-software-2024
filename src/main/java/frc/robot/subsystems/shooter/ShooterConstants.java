...
public class ShooterConstants {
  ...
  public static final double AMP_SIDE_AUTO_1_ANGLE = 30.5; // FIXME: tune
  ...
  public static final double AMP_SIDE_AUTO_4_ANGLE = 47.0; // FIXME: tune
  public static final double AMP_SIDE_AUTO_5_VELOCITY = 80.0;
  public static final double AMP_SIDE_AUTO_5_ANGLE = 39.0; // FIXME: tune
  public static final double AMP_SIDE_AUTO_6_VELOCITY = 80.0;
  public static final double AMP_SIDE_AUTO_6_ANGLE = 47.0; // FIXME: tune
